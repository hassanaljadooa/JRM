		...
		<>
			<div className="custom-scrollbar bg-black flex border-b border-b-slate-500 overflow-x-auto">
				<div className="p-1.5 flex gap-1">
					<Badge type="info" content={[<i className="fa-solid fa-calendar-days"></i> ," ",currentDate.toDateString()]} />
					...
					{displayMode === 'completed' && (
						<Badge type="success" content={`${todos.length} Completed`} />
					)}
				</div>
				<VerticalDivider />
				<div className="p-1.5 flex gap-1">
					...
					<button onClick={toggleDisplay}>
						<Badge content="Show Completed Reminders" />
					</button>
				</div>
			</div>
		</>
